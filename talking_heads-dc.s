...
; Build with vasm
; vasmm68k_mot -kick1hunks -Fhunkexe -o talking_heads-dc -nosym talking_heads-dc.s
...
cmdblock11	; conversation blink go right
...
srh	equ	21
	...
	dc.w	(0*srh+srv-1)<<8+$df,$fffe ; -> $07 is too late so $df
g0pos
...
; falling
	...
	dc.w	-1,$1fd4 ; signal (show) and wait
	...
	dc.w	-1,$2135 ; signal (show) and wait
precalcdataend
...
;	incbin	"3dtschak"
	...
	even
lspbank
	incbin	"talking_heads-dc.lsbank"
lspbankend

	even
lspmusic
	incbin	"talking_heads-dc.lsmusic",10	; skip header (10 bytes)
...
btext
	...
	; Lord's director's cut text
	dc.b	"      LORD ON THE KEYS AGAIN. AFTER DEPECHE AND I HAD A LITTLE "
	dc.b	"MISUNDERSTANDING (I NEVER SAW THE FINAL VERSION OF THE INTRO, "
	dc.b	"WE SORTED IT OUT WITH SOME NEW FEATURES FOR YOU. NOW WE ARE "
	dc.b	"DOING SOME BOINGS AND STUFF. WE HOPE YOU LIKE THIS DIRECTOR%S CUT "
	dc.b	"WHICH IS A BIT MORE PIRATE SINCE THE USE OF A KRAFTWERK SAMPLE. "
	dc.b	"WE HAD A NICE SAMPLING COPYRIGHT LEGAL WAR HERE IN GERMANY "
	dc.b	"ABOUT THIS. SO I WAS NOT QUITE SURE TO INCLUDE THE "
	dc.b	"BOING SAMPLE AT THE EVOKE DEMO PARTY. FUN FACT: "
	dc.b	"THERE WAS ANOTHER DEMO USING KRAFTWERK SAMPLES BY "
	dc.b	"ANOTHER GROUP IN THE COMPETITION. SO... AS I AM A BIG FRIEND "
	dc.b	"OF THE KLF COPYRIGHT SAMPLE POLICY I AM QUITE PLEASED "
	dc.b	"WITH THE NEW VERSION WHICH WAS "
	dc.b	"SOMEHOW TRIGGERED BY THE SWISS CRACKING ASSOCI$TION. "
	dc.b	"THANKS FOR YOUR FEEDBACK ON POUET! NEXT STOP FOR ME WILL "
	dc.b	"BE A LIVE CONCERT FOR YOUR PLEASURE AT AMIGA37! CU! "
	dc.b	"OVER AND OUT...      "
